...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('MENTION', 'DIRECT_MESSAGE', 'THREAD_REPLY', 'CHANNEL_ACTIVITY', 'SYSTEM');

-- CreateEnum
CREATE TYPE "DeliveryStatus" AS ENUM ('PENDING', 'SENT', 'FAILED');

-- CreateEnum
CREATE TYPE "IntegrationType" AS ENUM ('GITHUB', 'WEBHOOK', 'CUSTOM');

-- CreateEnum
CREATE TYPE "AuditAction" AS ENUM ('CREATE', 'UPDATE', 'DELETE', 'INVITE', 'LOGIN', 'LOGOUT', 'ROLE_CHANGE', 'BOT_COMMAND', 'INTEGRATION_EVENT');

-- CreateEnum
CREATE TYPE "BotEventType" AS ENUM ('MESSAGE_CREATED', 'MESSAGE_REACTION', 'CHANNEL_JOINED', 'SLASH_COMMAND');
...
-- CreateIndex
CREATE INDEX "User_isActive_lastSeenAt_idx" ON "User"("isActive", "lastSeenAt");
...
-- CreateIndex
CREATE INDEX "Workspace_isArchived_createdAt_idx" ON "Workspace"("isArchived", "createdAt");
...
-- CreateIndex
CREATE INDEX "Channel_workspaceId_isArchived_createdAt_idx" ON "Channel"("workspaceId", "isArchived", "createdAt");
...
-- CreateIndex
CREATE INDEX "ChannelMember_userId_joinedAt_idx" ON "ChannelMember"("userId", "joinedAt");
...
-- CreateIndex
CREATE INDEX "Thread_workspaceId_channelId_createdAt_idx" ON "Thread"("workspaceId", "channelId", "createdAt");
...
-- CreateIndex
CREATE INDEX "File_uploaderId_createdAt_idx" ON "File"("uploaderId", "createdAt");
...
-- CreateIndex
CREATE INDEX "Bot_workspaceId_isActive_idx" ON "Bot"("workspaceId", "isActive");

-- CreateIndex
CREATE UNIQUE INDEX "Bot_workspaceId_name_key" ON "Bot"("workspaceId", "name");

-- CreateIndex
CREATE INDEX "BotEvent_workspaceId_createdAt_idx" ON "BotEvent"("workspaceId", "createdAt");

-- CreateIndex
CREATE INDEX "BotEvent_botId_createdAt_idx" ON "BotEvent"("botId", "createdAt");

-- CreateIndex
CREATE INDEX "Integration_workspaceId_type_isActive_idx" ON "Integration"("workspaceId", "type", "isActive");
...
-- AddForeignKey
ALTER TABLE "BotEvent" ADD CONSTRAINT "BotEvent_workspaceId_fkey" FOREIGN KEY ("workspaceId") REFERENCES "Workspace"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "BotEvent" ADD CONSTRAINT "BotEvent_actorId_fkey" FOREIGN KEY ("actorId") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
